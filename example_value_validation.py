...
def demonstrate_value_validation():
    ...
    condition = {
        "fact": {"get_permissions": {"user_id": 999}},  # Non-existent user returns empty list
        "operator": "contains",
        "value": "admin"
    }
    errors = validate_condition(condition, UserFact)
    ...
    condition = {
        "fact": {"get_name": {"user_id": 999}},  # Non-existent user returns empty string
        "operator": "starts_with",
        "value": "A"
    }
    errors = validate_condition(condition, UserFact)
