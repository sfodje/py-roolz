...
class TestIntegrationBenchmarks:
    ...
    def test_ecommerce_workflow_benchmark(self, benchmark):
        ...
        class Order:
            def __init__(
                self, order_id, customer_id, total_amount, items, shipping_address
            ):
        ...
        orders = [
            ...
            Order(
                ...
                "CUST002",
                45.00,
                [{"name": "Book", "price": 25}, {"name": "Pen", "price": 20}],
                {"state": "NY"},
            ),
            Order(
                "ORD003",
        ...
        rules = [
            {
                ...
                "actions": [{"action": "apply_discount", "args": [10]}],
            },
            {
                "condition": {
                    "all": [
            ...
            },
            {
                ...
                "actions": [{"action": "flag_for_review", "args": ["Large order"]}],
            },
        ]
    ...
    def test_user_authentication_workflow_benchmark(self, benchmark):
        ...
        class User:
            def __init__(
                self, user_id, email, age, login_count, last_login, subscription_type
            ):
        ...
        rules = [
            ...
            },
            {
                ...
                "actions": [{"action": "activate_premium_features"}],
            },
            {
                "condition": {
                    "all": [
                ...
                "actions": [
                    {
                        ...
                        "args": ["High login count for free user"],
                    }
                ],
            },
        ]
        ...
        rules = [
            {
                "condition": {
                    "all": [
                        ...
                        {
                            "fact": "get_employment_years",
                            "operator": "greater_than",
                            "value": 2,
                        },
                    ]
                },
                "actions": [{"action": "approve_loan", "args": [3.5]}],
            },
            {
                "condition": {
                    "all": [
                ...
                "actions": [
                    {
                        ...
                        "args": ["Large loan relative to income"],
                    }
                ],
            },
        ]
    ...
    def test_custom_operator_integration_benchmark(self, benchmark):
        ...
        def is_anomaly(left_operand, right_operand):
            ...
            if isinstance(left_operand, (int, float)) and isinstance(
        ...
        rules = [
            {
                ...
                "actions": [{"action": "send_alert", "args": ["Anomaly detected"]}],
            },
            {
                "condition": {
                    "all": [
        ...
        rules = [
            # Temperature rules
            {
                ...
                "actions": [
                    {
                        "action": "log_alert",
                        "args": ["TEMP_HIGH", "High temperature detected"],
                    }
                ],
            },
            {
                ...
                "actions": [
                    {
                        "action": "log_alert",
                        "args": ["TEMP_LOW", "Low temperature detected"],
                    }
                ],
            },
            # Humidity rules
            {
                ...
                "actions": [
                    {
                        "action": "log_alert",
                        "args": ["HUMIDITY_HIGH", "High humidity detected"],
                    }
                ],
            },
            # Pressure rules
            {
                ...
                "actions": [
                    {"action": "log_critical_event", "args": ["Low pressure system"]}
                ],
            },
            # Combined conditions
            {
                ...
                "actions": [
                    {
                        "action": "log_alert",
                        "args": ["COMFORT_ISSUE", "Uncomfortable conditions"],
                    }
                ],
            },
        ]
